...
class DiffusionPlanner:
    ...
    def plan(self, args_train, args, rm2d_planner, i_e, start_point, goal_point):
        result_dict_list = []

        problems_dict = self.problems_dict # should be already preprocessed
        #print('\033[32m' + f"plan_pb_diff_helper problem_dict:{problems_dict['infos/wall_locations'][i_e][0]}" + '\033[0m')
        # (n_envs, n_probs, 2, 7)
        # probs = problems_dict['problems'] # 4d array of planning problems
        n_envs, n_prob_env  = problems_dict['problems'].shape[:2]
        # n_envs:300, n_prob_envs:200
        ...
        if args.seq_eval:
            ...
            vis_modelout_path_list, vis_maze_idxs_list, other_results = \
                rm2d_planner.plan_an_env(env, self.policy, self.use_normed_wallLoc, plan_env_config, start_point, goal_point)
        ...
        return avg_result_dict, vis_modelout_path_list
