...
def main(args_train, args):
    ...
    test_env_number = np.random.randint(0, 300)
    obstacles_coordinates = dplanner.problems_dict['infos/wall_locations'][test_env_number][0]
    avg_result_dict, result_dict_list = dplanner.plan(args_train, args, rm2d_planner, test_env_number)
    
    print(f"main result_dict_list:{result_dict_list}")
    print(f"obstacles_coordinates:{obstacles_coordinates}")
...
if __name__ == '__main__':
    ...
    #print('\033[32m' + "args_train:" + f"\n{args_train}" + '\033[0m')
    args = Parser().parse_args('plan')
    #print('\033[32m' + "args:" + f"\n{args}" + '\033[0m')
