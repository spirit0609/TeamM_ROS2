...
def generate_launch_description():
    ...
    omni_robot_sim_path = os.path.join(
    ...
    gazebo_resource_path = SetEnvironmentVariable(
        ...
        value=[
            os.path.join(omni_robot_sim_path, 'worlds'), ':' +
    ...
    bridge = Node(
        ...
        arguments=['/model/omni_robot/pose@tf2_msgs/msg/TFMessage@gz.msgs.Pose_V',
                   '/imu@sensor_msgs/msg/Imu@gz.msgs.IMU'],
        output='screen'
    )

    pure_pursuit = Node(package='robot_control',
